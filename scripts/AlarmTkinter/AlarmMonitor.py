...
class AlarmMonitor(object) :
   ...
   #Once we've initiated what is already in the system, start
   #monitoring. 
   def Monitor(self) :
      consumer = self.kafkaconsumer
      ...
      #If there is a message, deal with it as appropriate
      if (msg != None) :         
#         (msg,alarmname,topic) = message
         
         #No errors, create an alarm of the correct type.
      ...
      #After 100 ms do it again.
      root.after(10,self.Monitor)  
   ...
   def ActiveAlarm(self,msg) :
      ...
      print(alarmname,status,"***",msgtype,"***")
